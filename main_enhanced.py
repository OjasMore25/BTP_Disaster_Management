"""
Enhanced demo application with markdown output export
Saves responses as formatted markdown files with dynamic naming
"""
import json
import os
...
def generate_markdown_response(response, drone_input, scenario_name="Disaster Response"):
    ...
    for i, shelter in enumerate(response.relevant_shelters, 1):
        ...
        md.append(f"- **Contact:** {shelter.contact}")
...
def display_response_console(response, drone_input):
    """Pretty print RAG response to console"""
...
def run_demo_scenarios(save_to_markdown=True):
    """
    Run demo scenarios and optionally save to markdown
    
    Args:
        save_to_markdown: If True, save responses to markdown files
    """
    ...
    scenarios = [
        {
            ...
            "title": "Moderate Flood in Bandra Area",
            "input": {
                "latitude": 19.0596,
                "longitude": 72.8295,
                "flood_depth_cm": 120,
        ...
        },
        {
            ...
            "title": "Critical Flood in Dharavi Area",
            "input": {
                "latitude": 19.018,
                "longitude": 72.855,
                "flood_depth_cm": 250,
        ...
        },
        {
            ...
            "title": "High Flood in Eastern Suburbs",
            "input": {
                "latitude": 19.15,
                "longitude": 72.93,
                "flood_depth_cm": 180,
    ...
    for scenario in scenarios:
        print(f"\n{'='*80}")
        print(f"Processing: {scenario['title']}")
        print(f"{'='*80}\n")
        ...
        # Display in console
        display_response_console(response, drone_input)
        
        # Save to markdown if enabled
        if save_to_markdown:
...
if __name__ == "__main__":
    ...
    save_markdown = "--markdown" in sys.argv or "-m" in sys.argv
    
    if not save_markdown:
        print("💡 Tip: Use 'python main.py --markdown' to save responses as markdown files")
        print("   Files will be saved in 'responses/' directory with timestamps\n")
